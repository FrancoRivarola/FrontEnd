...
public class CExperiencia {
    ...
    public ResponseEntity<List<Experiencias>> list() {
        List<Experiencias> list = sExperiencia.list();
    ...
    public ResponseEntity<Experiencias> getbyId(@PathVariable("id") int id) {
        ...
        Experiencias experiencia = sExperiencia.getone(id).get();
    ...
    @PostMapping("/create")
    public ResponseEntity<?> create(@RequestBody DtoExperiencias dtoexp) {
        ...
        Experiencias experiencias = new Experiencias(dtoexp.getNombreE(), dtoexp.getDescripcionE());
        sExperiencia.save(experiencias);
            return new ResponseEntity(new Mensaje("Experiencia agregada"), HttpStatus.OK);
    }

    @PutMapping("/update/{id}")
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody DtoExperiencias dtoexp) {
        if (!sExperiencia.existsById(id)) {
